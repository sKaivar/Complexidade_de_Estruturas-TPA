...
Este projeto implementa uma **biblioteca própria de lista encadeada genérica em Java**, utilizando **Generics** e **Comparator<T>**, além de um **programa de gerenciamento de contatos** que utiliza essa biblioteca.
